export const settingsZhCN = {
  settings: {
    ...
    providerQnaigcTTS: 'QNAIGC TTS（七牛云）',
    ...
    providerQnaigcImage: 'QNAIGC 图像（七牛云 Gemini）',
...
export const settingsEnUS = {
  settings: {
    ...
    providerQnaigcTTS: 'QNAIGC TTS (Qiniu Cloud)',
    ...
    providerNanoBanana: 'Nano Banana (Gemini)',
    providerQnaigcImage: 'QNAIGC Image (Qiniu Gemini)',
